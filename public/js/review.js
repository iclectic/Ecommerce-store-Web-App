...
//             showFormError('Fill all the inputs');
//         } else if(reviewHeadline.value.length > 50){
//             showFormError('Headline should be more than 50 letters');
//         } else if(review.value.length > 150){
//             showFormError('Review should be more than 150 letters');
//         } else{
...
//                 <h2 class="review-title">best quality available anywhere on planet earth!!</h2>
//                 <p class="review">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
//             </div>
//     `
// }
