...
const firebaseConfig = {
  apiKey: "AIzaSyA8IHqkITbfCx5CA9ij9uQ4VWDOkZi6ZH0",
  authDomain: "e-commerce-website-6efaa.firebaseapp.com",
  projectId: "e-commerce-website-6efaa",
  storageBucket: "e-commerce-website-6efaa.appspot.com",
  messagingSenderId: "421113644601",
  appId: "1:421113644601:web:6d607141dbb1da1ad1efe8"
};
...
app.use(express.json()); // enables form sharing with server
...
const bucketName = "ibim-ecomm-web";
...
app.post('/signup', (req, res) => {
    ...
    if(name.length < 3){
      res.json({ 'alert' : 'name must be 3 letters long'});
        ...
        res.json({ 'alert' : 'enter a valid number'});
    } else if(!tac){
